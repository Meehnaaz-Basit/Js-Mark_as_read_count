...
const latestPost = async () => {
  ...
  const lastestPostTimeId = setTimeout(() => {
...
searchCategoryBtn.addEventListener("click", async () => {
  ...
  const allPostLoaderAfterSearch = `
   <div
      id="allPostLoaderAfterSearch"
      class="lg:p-12 p-6 my-4 text-center">
      <span class="loading loading-ring loading-lg"></span>
    </div>
   `;

  postContainer.innerHTML = allPostLoaderAfterSearch;
